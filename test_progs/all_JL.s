...
__L19:
	# _tmp167 = 0
	  lda		$r3, 0		# load (signed) int constant value 0 into $r3
	  stq		$r3, -1360($r15)	# spill _tmp167 from $r3 to $r15-1360
	# i = _tmp167
	  ldq		$r3, -1360($r15)	# fill _tmp167 to $r3 from $r15-1360
	  stq		$r3, -16($r15)	# spill i from $r3 to $r15-16
__L25:
	# _tmp168 = 13
	  lda		$r3, 13		# load (signed) int constant value 13 into $r3
	  stq		$r3, -1368($r15)	# spill _tmp168 from $r3 to $r15-1368
	# _tmp169 = i < _tmp168
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1368($r15)	# fill _tmp168 to $r2 from $r15-1368
	  cmplt		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1376($r15)	# spill _tmp169 from $r3 to $r15-1376
	# IfZ _tmp169 Goto __L26
	  ldq		$r1, -1376($r15)	# fill _tmp169 to $r1 from $r15-1376
	  blbc		$r1, __L26	# branch if _tmp169 is zero
	# _tmp170 = i < ZERO
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1384($r15)	# spill _tmp170 from $r3 to $r15-1384
	# _tmp171 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1392($r15)	# spill _tmp171 from $r3 to $r15-1392
	# _tmp172 = _tmp171 <= i
	  ldq		$r1, -1392($r15)	# fill _tmp171 to $r1 from $r15-1392
	  ldq		$r2, -16($r15)	# fill i to $r2 from $r15-16
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1400($r15)	# spill _tmp172 from $r3 to $r15-1400
	# _tmp173 = _tmp170 || _tmp172
	  ldq		$r1, -1384($r15)	# fill _tmp170 to $r1 from $r15-1384
	  ldq		$r2, -1400($r15)	# fill _tmp172 to $r2 from $r15-1400
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1408($r15)	# spill _tmp173 from $r3 to $r15-1408
	# IfZ _tmp173 Goto __L27
	  ldq		$r1, -1408($r15)	# fill _tmp173 to $r1 from $r15-1408
	  blbc		$r1, __L27	# branch if _tmp173 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L27:
	# _tmp174 = i << 3
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1416($r15)	# spill _tmp174 from $r3 to $r15-1416
	# _tmp175 = values + _tmp174
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1416($r15)	# fill _tmp174 to $r2 from $r15-1416
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1424($r15)	# spill _tmp175 from $r3 to $r15-1424
	# _tmp176 = i < ZERO
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1432($r15)	# spill _tmp176 from $r3 to $r15-1432
	# _tmp177 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1440($r15)	# spill _tmp177 from $r3 to $r15-1440
	# _tmp178 = _tmp177 <= i
	  ldq		$r1, -1440($r15)	# fill _tmp177 to $r1 from $r15-1440
	  ldq		$r2, -16($r15)	# fill i to $r2 from $r15-16
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1448($r15)	# spill _tmp178 from $r3 to $r15-1448
	# _tmp179 = _tmp176 || _tmp178
	  ldq		$r1, -1432($r15)	# fill _tmp176 to $r1 from $r15-1432
	  ldq		$r2, -1448($r15)	# fill _tmp178 to $r2 from $r15-1448
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1456($r15)	# spill _tmp179 from $r3 to $r15-1456
	# IfZ _tmp179 Goto __L28
	  ldq		$r1, -1456($r15)	# fill _tmp179 to $r1 from $r15-1456
	  blbc		$r1, __L28	# branch if _tmp179 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L28:
	# _tmp180 = i << 3
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1464($r15)	# spill _tmp180 from $r3 to $r15-1464
	# _tmp181 = values + _tmp180
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1464($r15)	# fill _tmp180 to $r2 from $r15-1464
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1472($r15)	# spill _tmp181 from $r3 to $r15-1472
	# _tmp182 = *(_tmp181)
	  ldq		$r1, -1472($r15)	# fill _tmp181 to $r1 from $r15-1472
	  ldq		$r3, 0($r1)	# load with offset
	  stq		$r3, -1480($r15)	# spill _tmp182 from $r3 to $r15-1480
	# _tmp183 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1488($r15)	# spill _tmp183 from $r3 to $r15-1488
	# _tmp184 = _tmp182 + _tmp183
	  ldq		$r1, -1480($r15)	# fill _tmp182 to $r1 from $r15-1480
	  ldq		$r2, -1488($r15)	# fill _tmp183 to $r2 from $r15-1488
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1496($r15)	# spill _tmp184 from $r3 to $r15-1496
	# *(_tmp175) = _tmp184
	  ldq		$r1, -1496($r15)	# fill _tmp184 to $r1 from $r15-1496
	  ldq		$r3, -1424($r15)	# fill _tmp175 to $r3 from $r15-1424
	  stq		$r1, 0($r3)	# store with offset
	# _tmp185 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1504($r15)	# spill _tmp185 from $r3 to $r15-1504
	# _tmp186 = i + _tmp185
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1504($r15)	# fill _tmp185 to $r2 from $r15-1504
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1512($r15)	# spill _tmp186 from $r3 to $r15-1512
	# _tmp187 = _tmp186 < ZERO
	  ldq		$r1, -1512($r15)	# fill _tmp186 to $r1 from $r15-1512
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1520($r15)	# spill _tmp187 from $r3 to $r15-1520
	# _tmp188 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1528($r15)	# spill _tmp188 from $r3 to $r15-1528
	# _tmp189 = _tmp188 <= _tmp186
	  ldq		$r1, -1528($r15)	# fill _tmp188 to $r1 from $r15-1528
	  ldq		$r2, -1512($r15)	# fill _tmp186 to $r2 from $r15-1512
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1536($r15)	# spill _tmp189 from $r3 to $r15-1536
	# _tmp190 = _tmp187 || _tmp189
	  ldq		$r1, -1520($r15)	# fill _tmp187 to $r1 from $r15-1520
	  ldq		$r2, -1536($r15)	# fill _tmp189 to $r2 from $r15-1536
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1544($r15)	# spill _tmp190 from $r3 to $r15-1544
	# IfZ _tmp190 Goto __L29
	  ldq		$r1, -1544($r15)	# fill _tmp190 to $r1 from $r15-1544
	  blbc		$r1, __L29	# branch if _tmp190 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L29:
	# _tmp191 = _tmp186 << 3
	  ldq		$r1, -1512($r15)	# fill _tmp186 to $r1 from $r15-1512
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1552($r15)	# spill _tmp191 from $r3 to $r15-1552
	# _tmp192 = values + _tmp191
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1552($r15)	# fill _tmp191 to $r2 from $r15-1552
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1560($r15)	# spill _tmp192 from $r3 to $r15-1560
	# _tmp193 = i < ZERO
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1568($r15)	# spill _tmp193 from $r3 to $r15-1568
	# _tmp194 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1576($r15)	# spill _tmp194 from $r3 to $r15-1576
	# _tmp195 = _tmp194 <= i
	  ldq		$r1, -1576($r15)	# fill _tmp194 to $r1 from $r15-1576
	  ldq		$r2, -16($r15)	# fill i to $r2 from $r15-16
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1584($r15)	# spill _tmp195 from $r3 to $r15-1584
	# _tmp196 = _tmp193 || _tmp195
	  ldq		$r1, -1568($r15)	# fill _tmp193 to $r1 from $r15-1568
	  ldq		$r2, -1584($r15)	# fill _tmp195 to $r2 from $r15-1584
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1592($r15)	# spill _tmp196 from $r3 to $r15-1592
	# IfZ _tmp196 Goto __L30
	  ldq		$r1, -1592($r15)	# fill _tmp196 to $r1 from $r15-1592
	  blbc		$r1, __L30	# branch if _tmp196 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L30:
	# _tmp197 = i << 3
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1600($r15)	# spill _tmp197 from $r3 to $r15-1600
	# _tmp198 = values + _tmp197
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1600($r15)	# fill _tmp197 to $r2 from $r15-1600
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1608($r15)	# spill _tmp198 from $r3 to $r15-1608
	# _tmp199 = *(_tmp198)
	  ldq		$r1, -1608($r15)	# fill _tmp198 to $r1 from $r15-1608
	  ldq		$r3, 0($r1)	# load with offset
	  stq		$r3, -1616($r15)	# spill _tmp199 from $r3 to $r15-1616
	# _tmp200 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1624($r15)	# spill _tmp200 from $r3 to $r15-1624
	# _tmp201 = i + _tmp200
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1624($r15)	# fill _tmp200 to $r2 from $r15-1624
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1632($r15)	# spill _tmp201 from $r3 to $r15-1632
	# _tmp202 = _tmp201 < ZERO
	  ldq		$r1, -1632($r15)	# fill _tmp201 to $r1 from $r15-1632
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1640($r15)	# spill _tmp202 from $r3 to $r15-1640
	# _tmp203 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1648($r15)	# spill _tmp203 from $r3 to $r15-1648
	# _tmp204 = _tmp203 <= _tmp201
	  ldq		$r1, -1648($r15)	# fill _tmp203 to $r1 from $r15-1648
	  ldq		$r2, -1632($r15)	# fill _tmp201 to $r2 from $r15-1632
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1656($r15)	# spill _tmp204 from $r3 to $r15-1656
	# _tmp205 = _tmp202 || _tmp204
	  ldq		$r1, -1640($r15)	# fill _tmp202 to $r1 from $r15-1640
	  ldq		$r2, -1656($r15)	# fill _tmp204 to $r2 from $r15-1656
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1664($r15)	# spill _tmp205 from $r3 to $r15-1664
	# IfZ _tmp205 Goto __L31
	  ldq		$r1, -1664($r15)	# fill _tmp205 to $r1 from $r15-1664
	  blbc		$r1, __L31	# branch if _tmp205 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L31:
	# _tmp206 = _tmp201 << 3
	  ldq		$r1, -1632($r15)	# fill _tmp201 to $r1 from $r15-1632
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1672($r15)	# spill _tmp206 from $r3 to $r15-1672
	# _tmp207 = values + _tmp206
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1672($r15)	# fill _tmp206 to $r2 from $r15-1672
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1680($r15)	# spill _tmp207 from $r3 to $r15-1680
	# _tmp208 = *(_tmp207)
	  ldq		$r1, -1680($r15)	# fill _tmp207 to $r1 from $r15-1680
	  ldq		$r3, 0($r1)	# load with offset
	  stq		$r3, -1688($r15)	# spill _tmp208 from $r3 to $r15-1688
	# _tmp209 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1696($r15)	# spill _tmp209 from $r3 to $r15-1696
	# _tmp210 = _tmp208 + _tmp209
	  ldq		$r1, -1688($r15)	# fill _tmp208 to $r1 from $r15-1688
	  ldq		$r2, -1696($r15)	# fill _tmp209 to $r2 from $r15-1696
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1704($r15)	# spill _tmp210 from $r3 to $r15-1704
	# _tmp211 = _tmp199 * _tmp210
	  ldq		$r1, -1616($r15)	# fill _tmp199 to $r1 from $r15-1616
	  ldq		$r2, -1704($r15)	# fill _tmp210 to $r2 from $r15-1704
	  mulq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1712($r15)	# spill _tmp211 from $r3 to $r15-1712
	# *(_tmp192) = _tmp211
	  ldq		$r1, -1712($r15)	# fill _tmp211 to $r1 from $r15-1712
	  ldq		$r3, -1560($r15)	# fill _tmp192 to $r3 from $r15-1560
	  stq		$r1, 0($r3)	# store with offset
	# _tmp212 = 2
	  lda		$r3, 2		# load (signed) int constant value 2 into $r3
	  stq		$r3, -1720($r15)	# spill _tmp212 from $r3 to $r15-1720
	# _tmp213 = i + _tmp212
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1720($r15)	# fill _tmp212 to $r2 from $r15-1720
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1728($r15)	# spill _tmp213 from $r3 to $r15-1728
	# _tmp214 = _tmp213 < ZERO
	  ldq		$r1, -1728($r15)	# fill _tmp213 to $r1 from $r15-1728
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1736($r15)	# spill _tmp214 from $r3 to $r15-1736
	# _tmp215 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1744($r15)	# spill _tmp215 from $r3 to $r15-1744
	# _tmp216 = _tmp215 <= _tmp213
	  ldq		$r1, -1744($r15)	# fill _tmp215 to $r1 from $r15-1744
	  ldq		$r2, -1728($r15)	# fill _tmp213 to $r2 from $r15-1728
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1752($r15)	# spill _tmp216 from $r3 to $r15-1752
	# _tmp217 = _tmp214 || _tmp216
	  ldq		$r1, -1736($r15)	# fill _tmp214 to $r1 from $r15-1736
	  ldq		$r2, -1752($r15)	# fill _tmp216 to $r2 from $r15-1752
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1760($r15)	# spill _tmp217 from $r3 to $r15-1760
	# IfZ _tmp217 Goto __L32
	  ldq		$r1, -1760($r15)	# fill _tmp217 to $r1 from $r15-1760
	  blbc		$r1, __L32	# branch if _tmp217 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L32:
	# _tmp218 = _tmp213 << 3
	  ldq		$r1, -1728($r15)	# fill _tmp213 to $r1 from $r15-1728
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1768($r15)	# spill _tmp218 from $r3 to $r15-1768
	# _tmp219 = values + _tmp218
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1768($r15)	# fill _tmp218 to $r2 from $r15-1768
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1776($r15)	# spill _tmp219 from $r3 to $r15-1776
	# _tmp220 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1784($r15)	# spill _tmp220 from $r3 to $r15-1784
	# _tmp221 = i + _tmp220
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1784($r15)	# fill _tmp220 to $r2 from $r15-1784
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1792($r15)	# spill _tmp221 from $r3 to $r15-1792
	# _tmp222 = _tmp221 < ZERO
	  ldq		$r1, -1792($r15)	# fill _tmp221 to $r1 from $r15-1792
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1800($r15)	# spill _tmp222 from $r3 to $r15-1800
	# _tmp223 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1808($r15)	# spill _tmp223 from $r3 to $r15-1808
	# _tmp224 = _tmp223 <= _tmp221
	  ldq		$r1, -1808($r15)	# fill _tmp223 to $r1 from $r15-1808
	  ldq		$r2, -1792($r15)	# fill _tmp221 to $r2 from $r15-1792
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1816($r15)	# spill _tmp224 from $r3 to $r15-1816
	# _tmp225 = _tmp222 || _tmp224
	  ldq		$r1, -1800($r15)	# fill _tmp222 to $r1 from $r15-1800
	  ldq		$r2, -1816($r15)	# fill _tmp224 to $r2 from $r15-1816
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1824($r15)	# spill _tmp225 from $r3 to $r15-1824
	# IfZ _tmp225 Goto __L33
	  ldq		$r1, -1824($r15)	# fill _tmp225 to $r1 from $r15-1824
	  blbc		$r1, __L33	# branch if _tmp225 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L33:
	# _tmp226 = _tmp221 << 3
	  ldq		$r1, -1792($r15)	# fill _tmp221 to $r1 from $r15-1792
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1832($r15)	# spill _tmp226 from $r3 to $r15-1832
	# _tmp227 = values + _tmp226
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1832($r15)	# fill _tmp226 to $r2 from $r15-1832
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1840($r15)	# spill _tmp227 from $r3 to $r15-1840
	# _tmp228 = *(_tmp227)
	  ldq		$r1, -1840($r15)	# fill _tmp227 to $r1 from $r15-1840
	  ldq		$r3, 0($r1)	# load with offset
	  stq		$r3, -1848($r15)	# spill _tmp228 from $r3 to $r15-1848
	# _tmp229 = 2
	  lda		$r3, 2		# load (signed) int constant value 2 into $r3
	  stq		$r3, -1856($r15)	# spill _tmp229 from $r3 to $r15-1856
	# _tmp230 = i + _tmp229
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1856($r15)	# fill _tmp229 to $r2 from $r15-1856
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1864($r15)	# spill _tmp230 from $r3 to $r15-1864
	# _tmp231 = _tmp230 < ZERO
	  ldq		$r1, -1864($r15)	# fill _tmp230 to $r1 from $r15-1864
	  cmplt		$r1, $r31, $r3	# perform the ALU op
	  stq		$r3, -1872($r15)	# spill _tmp231 from $r3 to $r15-1872
	# _tmp232 = *(values + -8)
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r3, -8($r1)	# load with offset
	  stq		$r3, -1880($r15)	# spill _tmp232 from $r3 to $r15-1880
	# _tmp233 = _tmp232 <= _tmp230
	  ldq		$r1, -1880($r15)	# fill _tmp232 to $r1 from $r15-1880
	  ldq		$r2, -1864($r15)	# fill _tmp230 to $r2 from $r15-1864
	  cmple		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1888($r15)	# spill _tmp233 from $r3 to $r15-1888
	# _tmp234 = _tmp231 || _tmp233
	  ldq		$r1, -1872($r15)	# fill _tmp231 to $r1 from $r15-1872
	  ldq		$r2, -1888($r15)	# fill _tmp233 to $r2 from $r15-1888
	  bis		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1896($r15)	# spill _tmp234 from $r3 to $r15-1896
	# IfZ _tmp234 Goto __L34
	  ldq		$r1, -1896($r15)	# fill _tmp234 to $r1 from $r15-1896
	  blbc		$r1, __L34	# branch if _tmp234 is zero
	# Throw Exception: Array subscript out of bounds
	  call_pal	0xDECAF		# (exception: Array subscript out of bounds)
	  call_pal	0x555		# (halt)
__L34:
	# _tmp235 = _tmp230 << 3
	  ldq		$r1, -1864($r15)	# fill _tmp230 to $r1 from $r15-1864
	  sll		$r1, 3, $r3	# perform the ALU op
	  stq		$r3, -1904($r15)	# spill _tmp235 from $r3 to $r15-1904
	# _tmp236 = values + _tmp235
	  ldq		$r1, 0($r29)	# fill values to $r1 from $r29+0
	  ldq		$r2, -1904($r15)	# fill _tmp235 to $r2 from $r15-1904
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1912($r15)	# spill _tmp236 from $r3 to $r15-1912
	# _tmp237 = *(_tmp236)
	  ldq		$r1, -1912($r15)	# fill _tmp236 to $r1 from $r15-1912
	  ldq		$r3, 0($r1)	# load with offset
	  stq		$r3, -1920($r15)	# spill _tmp237 from $r3 to $r15-1920
	# _tmp238 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1928($r15)	# spill _tmp238 from $r3 to $r15-1928
	# _tmp239 = _tmp237 + _tmp238
	  ldq		$r1, -1920($r15)	# fill _tmp237 to $r1 from $r15-1920
	  ldq		$r2, -1928($r15)	# fill _tmp238 to $r2 from $r15-1928
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1936($r15)	# spill _tmp239 from $r3 to $r15-1936
	# _tmp240 = _tmp228 * _tmp239
	  ldq		$r1, -1848($r15)	# fill _tmp228 to $r1 from $r15-1848
	  ldq		$r2, -1936($r15)	# fill _tmp239 to $r2 from $r15-1936
	  mulq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1944($r15)	# spill _tmp240 from $r3 to $r15-1944
	# *(_tmp219) = _tmp240
	  ldq		$r1, -1944($r15)	# fill _tmp240 to $r1 from $r15-1944
	  ldq		$r3, -1776($r15)	# fill _tmp219 to $r3 from $r15-1776
	  stq		$r1, 0($r3)	# store with offset
	# _tmp241 = 1
	  lda		$r3, 1		# load (signed) int constant value 1 into $r3
	  stq		$r3, -1952($r15)	# spill _tmp241 from $r3 to $r15-1952
	# _tmp242 = i + _tmp241
	  ldq		$r1, -16($r15)	# fill i to $r1 from $r15-16
	  ldq		$r2, -1952($r15)	# fill _tmp241 to $r2 from $r15-1952
	  addq		$r1, $r2, $r3	# perform the ALU op
	  stq		$r3, -1960($r15)	# spill _tmp242 from $r3 to $r15-1960
	# i = _tmp242
	  ldq		$r3, -1960($r15)	# fill _tmp242 to $r3 from $r15-1960
	  stq		$r3, -16($r15)	# spill i from $r3 to $r15-16
	# Goto __L25
	  br		__L25		# unconditional branch
__L26:
	# EndFunc
